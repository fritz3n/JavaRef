...
<html>
    ...
    <body>
        ...
        <div class="content">
		<p><font size="6"><strong>Bitte geben Sie ihre Adressdaten an.</strong></font><br><br>
		...
		<form action="https://fritzen.xyz/vielendank.html">		
			...
			<input type="radio" name="geschlecht" id="divers" value="divers" required>
	        <br>
